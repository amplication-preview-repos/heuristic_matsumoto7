...
@InputType()
class ReservationCreateNestedManyWithoutDriversInput {
...
export { ReservationCreateNestedManyWithoutDriversInput as ReservationCreateNestedManyWithoutDriversInput };
