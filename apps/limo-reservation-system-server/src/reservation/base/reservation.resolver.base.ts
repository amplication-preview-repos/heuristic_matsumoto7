...
export class ReservationResolverBase {
  ...
  @graphql.ResolveField(() => Limo, {
    nullable: true,
    name: "limo",
  })
  async getLimo(@graphql.Parent() parent: Reservation): Promise<Limo | null> {
    const result = await this.service.getLimo(parent.id);
